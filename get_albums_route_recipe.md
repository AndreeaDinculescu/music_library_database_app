...
describe Application do
  ...
  it 'should return the list of albums' do
    ...
    expected_response = 'Surfer Rosa, Super Trouper, Bossanova, Lover, Folklore, I Put a Spell on You, Baltimore, Here Comes the Sun, Fodder on My Wings, Doolittle, Waterloo, Mezzanine, Moon'
