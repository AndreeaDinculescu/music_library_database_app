...
sequenceDiagram
  ...
  A->>R: Calls method post /artists on body params name=Wild nothing,genre=Indie. Calls method create(new_artist) in ArtistRepository class
  R->>D: in ArtistRepository class in method created(new_artist) INSERT INTO artists (name, genre)  VALUES (Wild Nothing, Indie)
